...
contract FantasyCards is Context, IFantasyCards, AccessControlDefaultAdminRules {
     ...
     * Usage of this method is restricted to accounts with the EXECUTION_DELEGATE_ROLE.
     * Requires the msg.sender to be the owner, approved, or an authorized operator.
     ...
     */
    function safeMint(address to) public onlyRole(EXECUTION_DELEGATE_ROLE) {
